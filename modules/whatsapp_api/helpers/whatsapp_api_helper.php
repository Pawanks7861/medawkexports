...
if (!function_exists('getWhatsappAfterTypes')) {
    function getWhatsappAfterTypes()
    {
        return [
            [
                'id' => 'minute',
                'name' => _l('whatsapp_after_minute')
            ],
            [
                'id' => 'hour',
                'name' => _l('whatsapp_after_hour')
            ],
            [
                'id' => 'day',
                'name' => _l('whatsapp_after_day')
            ]
        ];
    }
}

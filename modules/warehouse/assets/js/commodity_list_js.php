<script>
  ...
  (function($) {
    ...
    var ProposalServerParams = {
      ...
      "group_ids": "[name='group_name']",
      "sub_group_name": "[name='sub_group_name']",
    };
    ...
    $('select[name="group_name"]').on('change', function() {
      ...
      var data_select = {};
      data_select.group_id = $('select[name="group_name"]').val();


      $.post(admin_url + 'warehouse/get_subgroup_fill_data', data_select).done(function(response) {
        response = JSON.parse(response);
        $("select[name='sub_group_name']").html('');

        $("select[name='sub_group_name']").append(response.subgroup);
        $("select[name='sub_group_name']").selectpicker('refresh');

        if (sub_group_value != '') {

          $("select[name='sub_group_name']").val(sub_group_value).change();
          sub_group_value = '';
        }
  ...
  function expenseSubmitHandler(form) {
    ...
    data.investor = $('select[name="investor"]').val();
  ...
  function edit_commodity_item(invoker) {
    ...
    if ($(invoker).data('investor') != 0) {
      $('#commodity_list-add-edit select[name="investor"]').val($(invoker).data('investor')).change();
    } else {
      $('#commodity_list-add-edit select[name="investor"]').val('').change();
    }

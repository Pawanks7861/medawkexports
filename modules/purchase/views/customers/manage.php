            ...
            <div class="panel_s">
               <div class="panel-body">
                     ...
                     <div class="modal-dialog" role="document">
                        <div class="modal-content">
                           ...
                           <div class="modal-body">
                              <?php if (has_permission('purchase_customers', '', 'delete') || is_admin()) { ?>
                  ...
                  $_table_data = array(
                     ...
                     array(
                        'name' => _l('Property Name'),
                        'th_attrs' => array('class' => 'toggleable', 'id' => 'th-property-name')
                     ),
                     array(
                        'name' => _l('Flat'),
                        'th_attrs' => array('class' => 'toggleable', 'id' => 'th-flat-name')
                     ),

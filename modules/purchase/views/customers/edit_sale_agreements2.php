                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="whereas">
                            ...
                            ?>
                            <p>AND WHEREAS the Allottee being desirous to purchase a residential flats in the said Scheme, approached the Promoter and after verifying all papers, documents, plans, specifications etc. and finding the titles of the Promoter to the said land and construction standing thereon as clear, marketable and free from all encumbrances and beyond reasonable doubts, has decided to purchase the property being <strong>Flat No. <?= $flat_name ?></strong> on the <strong><?= $floor_name ?></strong> of <strong>Block “<?= $block_name ?>”</strong>, admeasuring <strong><?= $banakhat_details->carpet_area ?> sq.mtrs carpet area</strong>; including <strong>balcony <?= $banakhat_details->balcony ?> sq.mtrs</strong> and <strong>wash area <?= $banakhat_details->wash_yard ?> sq.mtrs</strong>, together with undivided proportionate land share <strong><?= round($banakhat_details->undivided_land_share, 2) ?> sq.mtrs</strong> in the said land, more particularly described in the Schedule-A. (hereinafter referred to as “<strong>said Shop/Flat</strong>” and/or “<strong>said Premises</strong>” and/or “<strong>said Apartment</strong>”.).</p>
                            <?php $token_amount = isset($customer['tokan_amount']) ? $customer['tokan_amount'] : ''; ?>    
                            <p><strong>I)</strong>AND WHEREAS, Prior to execution, the Allottee paid <strong>Rs. <?= $token_amount ?> /-</strong> <strong>(Rupees <?= convertToIndianCurrency($token_amount) ?> only)</strong>, being part payment of the sale consideration of the said flat agreed to be sold by the Promoter to the Allottee as advance payment or Application Fee (the payment and receipt whereof the Promoter hereby admits and acknowledges) and the Allottee has agreed to pay to the Promoter the balance of the sale consideration in the manner hereinafter appearing.</p>
                        ...
                        <p>All that piece or parcel of immovable property being <strong>Flat No. <?= $flat_name ?></strong>, on the <strong><?= $floor_name ?></strong> of <strong>Block “<?= $block_name ?>”</strong>, admeasuring <strong><?= $banakhat_details->carpet_area ?> sq.mtrs. carpet area</strong>; including net carpet area of <strong>balcony admeasuring <?= $banakhat_details->balcony ?> sq.mtrs.</strong>; <strong>wash area admeasuring <?= $banakhat_details->wash_yard ?> sq.mtrs.</strong>; in the scheme known as <strong>“Kautilya Two20”</strong>; together with <strong>undivided proportionate share admeasuring <?= round($banakhat_details->undivided_land_share, 2) ?> sq.mtrs.</strong> in the Freehold Non-agricultural land for Multipurpose use bearing Final Plot No.17 admeasuring 5227 sq.mtrs of preliminary Town Planning Scheme No.216 (Shilaj) comprised of Block No.519 admeasuring 7466 sq.mtrs, situate, lying and being at Mouje SHILAJ, Taluka Ghatlodia in the Registration District of Ahmedabad and Sub-District of Ahmedabad-9 (Bopal) together with a right to use common facilities and amenities of the scheme and Said flat is bounded as follows : - </p>

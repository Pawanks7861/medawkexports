...
<div class="message-input">
   ...
   <textarea type="text" id="message" class="inputmsg auto-adjust-textarea-sms-whats" placeholder="Write your message here..."></textarea>
   ...
   echo '<button class="submit" data-lead="' . $sender_id . '" data-type="' . $sender_type . '" ' . $disabledButton . '><i class="fa fa-paper-plane" data-lead="' . $sender_id . '" data-type="' . $sender_type . '" aria-hidden="true"></i></button>';
   ?>
</div>
<script>
   var textareasSMS = '';
   ...
   $(document).on('click', '.message-input button.submit', function(event) {

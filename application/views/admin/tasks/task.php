                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="priority"
                                        class="control-label"><?php echo _l('Lead Status'); ?></label>
                                    <?php $get_current_lead_status = get_current_lead_status($rel_id); ?>
                                    <select name="lead_status" class="selectpicker" id="lead_status" data-width="100%"
                                        data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                        <?php foreach ($lead_status as $status) { ?>
                                            <option value="<?php echo e($status['id']); ?>" <?php if ($get_current_lead_status == $status['id']) {
                                                                                                echo ' selected';

                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content tw-mt-3">
                            <div role="tabpanel" class="tab-pane active" id="tab_project">
                                ...
                                ?>
                                <div id="project_cost" class="<?php echo e($input_field_hide_class_total_cost); ?> row">
                                    <div class="col-md-6">
                                        <?php $value = (isset($project) ? $project->project_cost : ''); ?>
                                        <?php echo render_input('project_cost', 'project_total_cost', $value, 'number'); ?>
                                    </div>
                                    <div class="col-md-6">
                                        <?php $value = (isset($project) ? $project->rera_no : ''); ?>
                                        <?php echo render_input('rera_no', 'Rera No.', $value, 'text'); ?>
                                    </div>
                                </div>
                                <?php

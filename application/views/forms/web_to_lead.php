...
<head>
    ...
    <style>
        ...
        .web-to-lead input[type="email"],
        .web-to-lead input[type="number"],
        .web-to-lead input[type="tel"],
        .web-to-lead input[type="password"],
        .web-to-lead select,
        ...
        .web-to-lead #form_submit {
            ...
            background: #ffffff url(https://kautilyadevelopers.in/wp-content/themes/builderexpert/assets/images/background/pattern-18.png) repeat-x;
